  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      margin: const EdgeInsets.symmetric(
        horizontal: CODEUNIONSpacing.lg * 2,
        vertical: CODEUNIONSpacing.xs,
      ),
      width: CODEUNIONSpacing.spaceUnit*100,
      height: CODEUNIONSpacing.xxlg,
      decoration: BoxDecoration(
        ...
        borderRadius: const BorderRadius.all(
          Radius.circular(CODEUNIONSpacing.xxs * 5),
        ),
      ),
      child: Center(
        child: Text(
          ...
          style: theme.textTheme.labelLarge?.copyWith(
            ...
            color: textColor ?? CODEUNIONColors.black,
          ),
        ),
      ),
    );
