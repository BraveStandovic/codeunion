abstract class CODEUNIONSpacing {
  /// The default unit of Appbar
  ...
  static const double xlg = 1.55 * spaceUnit;
  ...
  /// xxxlg spacing value (32pt)
  static const double lg2 = 2 * spaceUnit;
