...
class CODEUNIONAppBar extends StatelessWidget {
  /// {@macro app_app_bar}
  const CODEUNIONAppBar({
    super.key,
    this.widgetTitle,
    this.textTitle,
    this.titleTextStyle,
  ...
  CODEUNIONAppBar.redAppBar({
    ...
    this.actions,
    this.buttonStyle,
    this.backgroundColor = CODEUNIONColors.red,
    this.automaticallyImplyLeading,
  })  : elevation = 5,
        widgetTitle = Text(textTitle!),
        centerTitle = true,
